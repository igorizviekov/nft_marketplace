  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flexCenter w-full text-center p-4 sm:p-0">
          <h2 className="font-poppins dark:text-white text-nft-black-1 font-normal text-2xl">
            {header}
          </h2>
        </div>
        <div className="p-10 sm:py-0 border-t border-b dark:border-nft-black-3 border-nft-gray-1">
          {body}
        </div>
        <div className="flexCenter p-4 sm:p-0">{footer}</div>
      </div>
    </div>
  );
};
